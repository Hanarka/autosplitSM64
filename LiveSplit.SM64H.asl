...
startup {
    ...
    settings.Add("oneSplit", false, "Split Star 1", "starSplitOption");
    settings.Add("eightSplit", false, "Split Star 8", "starSplitOption");
    settings.Add("elevenSplit", false, "Split Star 11", "starSplitOption");
    settings.Add("thirteenSplit", false, "Split Star 13", "starSplitOption");
    settings.Add("eighteenSplit", false, "Split Star 18", "starSplitOption");
    settings.Add("twentySplit", false, "Split Star 20", "starSplitOption");
    settings.Add("twentysevenSplit", false, "Split Star 27", "starSplitOption");
    settings.Add("thirtySplit", false, "Split Star 30", "starSplitOption");
    settings.Add("thirtysixSplit", false, "Split Star 36", "starSplitOption");
    settings.Add("thirtynineSplit", false, "Split Star 39", "starSplitOption");
    settings.Add("fourtyfiveSplit", false, "Split Star 45", "starSplitOption");
    settings.Add("fourtyeightSplit", false, "Split Star 48", "starSplitOption");
    settings.Add("fiftyfourSplit", false, "Split Star 54", "starSplitOption");
    settings.Add("fiftynineSplit", false, "Split Star 59", "starSplitOption");
    settings.Add("sixtythreeSplit", false, "Split Star 63", "starSplitOption");
    settings.Add("seventySplit", false, "Split Star 70", "starSplitOption");
...
split {
    ...
    if (!settings["courseSplit"]) {
        ...
        if (settings["oneSplit"] && current.mapID != vars.launchMapID && old.mapID != vars.launchMapID && current.starNumber > old.starNumber && current.starNumber == 1 && old.starNumber == 0) {
            return true;
        }
        if (settings["eightSplit"] && current.mapID != vars.launchMapID && old.mapID != vars.launchMapID && current.starNumber > old.starNumber && current.starNumber == 8 && old.starNumber == 7) {
            return true;
        }
    }
